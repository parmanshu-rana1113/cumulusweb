...
<h2 className="font-semibold text-[#667085] text-xs mt-2">
      ...
      <div className="">
        <h2 className="font-semibold text-[#667085] text-xs mt-2">Shared file</h2>
        <NavLink
          to="/SharedFiles"
          onClick={() => setOpenMenuId(null)}
          className={({ isActive }) =>
      ...
      <div className="">
        ...
        >
          <span className="flex flex-grow" onClick={handleClickhelp}>
          <CircleAlertIcon className="h-5 w-5"/>
            <h2 className="ml-3 text-sm font-medium">Help and Support</h2>
          </span>
