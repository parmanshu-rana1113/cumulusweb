...
import whiteafterlife from "../../assets/whiteafterlife.png"
  ...
  return (
    <>
      ...
      /> */}
          ...
          {/* Transfer */}
          <div>
            <h2 className="font-semibold mt-2 text-[#667085] text-sm">Transfer</h2>
            <NavLink
              to="/afterlifeaccess"
              onClick={() => setOpenMenuId(null)}
              className={({ isActive }) =>
                `flex cursor-pointer p-2 rounded mb-2 ${isActive ? "bg-[#0067FF] text-white" : "text-[#434A60]"}`
              }
            >
              {({ isActive }) => (
                <span className="flex items-center h-6">
                  <img
                    src={isActive ? whiteafterlife : aftertlife} // Dynamically change image based on isActive
                    alt="Microphone Icon"
          ...
          <div className="">
            <h2 className="font-semibold text-[#667085] text-sm mt-1">Shared file</h2>
            <NavLink
              to="/SharedFiles"
              className={({ isActive }) =>
                `flex mb-2 cursor-pointer p-2 rounded  ${isActive ? "bg-blue-500 text-white" : "text-[#434A60]"
